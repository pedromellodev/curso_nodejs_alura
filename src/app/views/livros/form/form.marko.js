...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/nodealura$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.livro.id) {
    out.w("<div><input type=\"hidden\" name=\"_method\" value=\"PUT\"><input type=\"hidden\" name=\"_method\" value=\"DELETE\"><input type=\"hidden\" id=\"id\" name=\"id\"" +
...
marko_template.meta = {
    id: "/nodealura$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
